...
const SUITE_PACKAGES = /^@proworks-hub\/(contracts|forgeiq|costiq|prime|receiptiq|platform-events|platform-runtime|workorderiq|tracking|inventoryiq)(\/|$)/;
...
describe("engine suite portability", () => {
  ...
  it("lets no package in the suite import another, contracts excepted", () => {
    ...
    for (const name of ["forgeiq", "costiq", "prime", "receiptiq", "workorderiq", "tracking", "inventoryiq", "platform-events", "platform-runtime"]) {
  ...
  it("keeps the pure engines free of I/O and host frameworks", () => {
    ...
    const PURE_PACKAGES = ["prime", "costiq", "receiptiq", "contracts", "workorderiq", "platform-events", "platform-runtime", "tracking", "inventoryiq"];
  ...
  it("declares only suite packages and zod as runtime dependencies", () => {
    ...
    for (const name of ["contracts", "forgeiq", "costiq", "prime", "receiptiq", "workorderiq", "platform-events", "platform-runtime", "tracking", "inventoryiq"]) {
