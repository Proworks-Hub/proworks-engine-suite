...
// ─────────────────────────────────────────────────────────────────────────────
// Exact rational arithmetic — the substrate of the ownership solve (M-1).
// An ownership percentage that depends on an iteration count or a floating-
// point rounding is not reproducible; a 1/3 cross-holding has an exact
// rational answer and no exact double one.
// ─────────────────────────────────────────────────────────────────────────────
